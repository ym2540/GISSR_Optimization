...
def setrun(claw_pkg='geoclaw'):
    ...
    amrdata.refinement_ratios_x = [2, 2, 2, 6, 16, 16]
    amrdata.refinement_ratios_y = [2, 2, 2, 6, 16, 16]
    amrdata.refinement_ratios_t = [2, 2, 2, 6, 16, 16]
    ...
    regions.append([3,3,days2seconds(-1.0),days2seconds(0.5),-96,-92,28,30])
    regions.append([6,6,days2seconds(-1.0),days2seconds(0.5),-94.62,-94.30,29.33,29.34])
    # Gauges from Ike AWR paper (2011 Dawson et al)

    #rundata.gaugedata.gauges.append([1, -95.4, 29.49,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    #rundata.gaugedata.gauges.append([2, -95.04, 29.49,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    #rundata.gaugedata.gauges.append([3, -94.71, 29.49,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    #rundata.gaugedata.gauges.append([4, -94.39, 29.49,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    #rundata.gaugedata.gauges.append([5, -94.13, 29.49,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    #rundata.gaugedata.gauges.append([6, -95.4, 29.28,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    #rundata.gaugedata.gauges.append([7, -95.04, 29.28,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    #rundata.gaugedata.gauges.append([8, -94.71, 29.28,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    #rundata.gaugedata.gauges.append([9, -94.39, 29.28,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    #rundata.gaugedata.gauges.append([10, -94.13, 29.28,
    #                                 rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])

    for i in range(30):
        for j in range(10):
            rundata.gaugedata.gauges.append([j*100+i,-94.6+i*0.00927 ,29.3333333+0.0005*(j-2),
                                             rundata.clawdata.t0,
                                             rundata.clawdata.tfinal])        
...
def setgeo(rundata):
    ...
    topo_path = os.path.join('beach_nowall.tt3')
