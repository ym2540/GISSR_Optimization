# encoding: utf-8
"""
NOTE: Modified setrun

Module to set up run time parameters based on csv for Clawpack.
...
#------------------------------
    ...
    # Latex shelf
    # regions.append([1, 5, rundata.clawdata.t0, rundata.clawdata.tfinal, # -97.5, -88.5, 27.5, 30.5])

    regions.append([1, 4, rundata.clawdata.t0, rundata.clawdata.tfinal, -95.8666, -93.4, 28.63333, 30.2])
...
#-------------------
    ...
    storm_path = paths["storm_path"]
    topo_path = paths["topo_path"]
    ...
    geo_data.manning_coefficient = 0.025 # Overridden below ### TODO
